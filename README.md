...
一个 Safari 浏览器侧边栏 AI 助手，支持配置提供 OpenAI 风格接口的模型提供商（如 Openrouter、AIHubMix），具备网页摘要和选文解释等功能。
...
- **浏览器适配**：需支持用户插件，个人开发用的 Safari 的 [quoid/userscripts](https://github.com/quoid/userscripts) 插件来测试和开发，Chrome 用 Tampermonkey 或许也可以。
...
1. 打开侧边栏，点击顶部的**设置**图标。
2. 在 对话模型设置-模型提供方 右侧管理按钮点击进入**提供方管理**，选择你的 AI 服务商并填入 API Key。
3. 在设置中选择你想要使用的对话模型和摘要模型（可选）。
